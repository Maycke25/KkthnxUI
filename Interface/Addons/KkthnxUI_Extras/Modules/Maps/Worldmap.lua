...
--	Font replacement
----------------------------------------------------------------------------------------
WorldMapFrameAreaLabel:SetFont(cfg.uiFont, 30)
WorldMapFrameAreaLabel:SetShadowOffset(2, -2)
WorldMapFrameAreaLabel:SetTextColor(0.9, 0.83, 0.64)

WorldMapFrameAreaPetLevels:SetFont(cfg.uiFont, 30)
WorldMapFrameAreaPetLevels:SetShadowOffset(2, -2)

WorldMapFrameAreaDescription:SetFont(cfg.uiFont, 30)
...
hooksecurefunc("WorldMap_ToggleSizeDown", function()
	...
	WorldMapFrame:SetPoint("BOTTOM", UIParent, "BOTTOM", -120, 320)
end)
