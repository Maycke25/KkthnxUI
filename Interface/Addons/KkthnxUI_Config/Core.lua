...
local function Local(o)
	...
	if o == "UIConfigblizzardaltpowerbar" then o = L_GUI_BLIZZARD_ALTPOWERBAR end
	...
	if o == "UIConfigchatchannelreplace" then o = L_GUI_CHAT_CHANNELREPLACE end
...
function CreateUIConfig()
	...
	TitleBoxVerText:SetText("|cFF4488FFKkthnx's|r |cFFFEB200UI|r "..K.Version)
	...
	for i in pairsByKey(ALLOWED_GROUPS) do
		...
		button:SetScript("OnClick", function(self) ShowGroup(i, button) self:SetText("|cff00ff00"..K.option.."|r") end)
		offset = offset + 20
	end
	child:SetWidth(125)
...
do
	...
	frame.name = "|cFF4488FFKkthnx's|r |cFFFEB200UI|r"
	frame:SetScript("OnShow", function(self)
		...
		subtitle:SetText("GitHub: |cff298F00https://github.com/Kkthnx/KkthnxUI|r  -  |cff298F00https://github.com/Kkthnx/KkthnxUI/commits/master|r")
...
button:SetText("|cFF4488FFKkthnx's|r |cFFFEB200UI|r")
