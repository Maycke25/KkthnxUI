...
L_GUI_BLIZZARD_QUESTBUTTON_SIZE = "ObjectiveTracker quest button size"
...
L_GUI_BUFFS_CAST_BY = "Shows who cast a buff/debuff in its tooltip"
...
L_GUI_MISC_HIDE_RAREALERT = "Alerts you when a rare creature or treasure appears on your minimap"
L_GUI_MISC_LFGQUEUETIMER = "Simple timer for your LFG pop as to when it will expire"
L_GUI_MISC_MOUNT_DROP = "Announce when a rare mount drops"
...
L_GUI_TOOLTIP_SCALE = "Scale the size of the tooltip"
...
L_GUI_UNITFRAME_PORTRAITS = "Change the portraits to class icons"
L_GUI_UNITFRAME_CLASS_HEALTH = "Change the healthbars to class color."