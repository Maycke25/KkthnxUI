...
local menuList = {
	...
	},
	{
		...
		-- icon = 'Interface\\AddOns\\KkthnxUI_Actionbars\\media\\picomenu\\picomenuTalents',
		func = function()
	...
	},
	{
		...
		icon = 'Interface\\AddOns\\KkthnxUI_Actionbars\\media\\picomenu\\picomenuAchievement',
		func = function()
...
f:SetNormalTexture('Interface\\AddOns\\KkthnxUI_Actionbars\\media\\picomenu\\picomenuNormal')
f:GetNormalTexture():SetSize(30, 30)

f:SetHighlightTexture('Interface\\AddOns\\KkthnxUI_Actionbars\\media\\picomenu\\picomenuHighlight')
