...
local function CreateInfoString(button, position)
	...
	str:SetFont("Interface\\AddOns\\KkthnxUI\\Media\\Fonts\\Normal.ttf", 11, "OUTLINE")
...
local function ItemButton_Scaffold(self)
	...
	self.Border:SetPoint("TOPLEFT", self.Icon, -2, 2)
	self.Border:SetPoint("BOTTOMRIGHT", self.Icon, 2, -2)
