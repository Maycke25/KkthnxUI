...
function SetBorderShadowColor(self, r, g, b, a)
...
function SetBorderGlowColor(self, r, g, b, a)
...
-----------------
function SetBorderSize(self, size)
...
------------------
function SetBorderPadding(self, T, B, L, R)
	local t = self.borderTextures
	if t and T then
...
function CreateBorder(self, size, padding, layer, shadowLayer)
	...
	if not (self.borderTextures) then
		...
		for i = 1, #sections do 
			...
			t:SetParent(self)
			t:SetTexture("Interface\\Addons\\KkthnxUI_Media\\Media\\Textures\\textureNormal")
			t:SetVertexColor(1, 1, 1, 1)
			b[sections[i]] = t

			t = self:CreateTexture(nil, shadowLayer or 'BORDER')
			t:SetParent(self)
			t:SetTexture("Interface\\Addons\\KkthnxUI_Media\\Media\\Textures\\textureShadow")
			...
			t:SetParent(self)
			t:SetTexture("Interface\\Addons\\KkthnxUI_Media\\Media\\Textures\\textureGlow")
