...
if C.misc.filger ~= true then return end

Filger_Settings = {
	max_test_icon = 5,
}

AnchorBUFF_ICON = CreateFrame("Frame","BUFFICONAnchor",UIParent) 
AnchorBUFF_ICON:SetPoint("RIGHT", UIParent, "CENTER", -213, 0) ---
AnchorBUFF_ICON:SetHeight(37)
AnchorBUFF_ICON:SetWidth(37)

AnchorT_BUFF_ICON = CreateFrame("Frame","TBUFFICONAnchor",UIParent)
AnchorT_BUFF_ICON:SetPoint("LEFT", UIParent, "CENTER", 213, -5)
AnchorT_BUFF_ICON:SetHeight(37)
AnchorT_BUFF_ICON:SetWidth(37)

AnchorP_PROC_ICON = CreateFrame("Frame","PPROCICONAnchor",UIParent)
AnchorP_PROC_ICON:SetPoint("RIGHT", UIParent, "CENTER", -213, -40) ----
AnchorP_PROC_ICON:SetHeight(37)
AnchorP_PROC_ICON:SetWidth(37)

AnchorT_DEBUFF_ICON = CreateFrame("Frame","TDEBUFFICONAnchor",UIParent)
AnchorT_DEBUFF_ICON:SetPoint("LEFT", UIParent, "CENTER", 213, -56)
AnchorT_DEBUFF_ICON:SetHeight(37)
AnchorT_DEBUFF_ICON:SetWidth(37)

AnchorT_SPECIAL_P_BUFF_ICON = CreateFrame("Frame","SPECIALPBUFFICONAnchor",UIParent)
AnchorT_SPECIAL_P_BUFF_ICON:SetPoint("RIGHT", UIParent, "CENTER", -213, 40) ---
AnchorT_SPECIAL_P_BUFF_ICON:SetHeight(37)
AnchorT_SPECIAL_P_BUFF_ICON:SetWidth(37)

Anchor_CD = CreateFrame("Frame","CDAnchor",UIParent)
Anchor_CD:SetPoint("CENTER", UIParent, "CENTER", -120, -94)
Anchor_CD:SetHeight(40)
Anchor_CD:SetWidth(40)

Anchor_PVEPVPCD = CreateFrame("Frame","PVEPVPCDAnchor",UIParent)
Anchor_PVEPVPCD:SetPoint("LEFT", UIParent, "CENTER", 213, 40)
Anchor_PVEPVPCD:SetHeight(25)
Anchor_PVEPVPCD:SetWidth(25)

Anchor_PVEDEBUFF = CreateFrame("Frame","PVEDEBUFFAnchor",UIParent)
Anchor_PVEDEBUFF:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 720)
Anchor_PVEDEBUFF:SetHeight(37)
Anchor_PVEDEBUFF:SetWidth(37)

Anchor_TIGERPOWER = CreateFrame("Frame","TIGERPOWERAnchor",UIParent)
Anchor_TIGERPOWER:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 650)
Anchor_TIGERPOWER:SetHeight(50)
		...
		if not bar then
			...
			if self.Mode == "ICON" then
				...
				if bar.count then
					...
					bar.count:SetFont(C.font.basic_font, C.font.basic_font_size, C.font.basic_font_style)
				...
				if bar.time then
					...
					bar.time:SetFont(C.font.basic_font, C.font.basic_font_size, C.font.basic_font_style)
				...
				if bar.spellname then
					...
					bar.spellname:SetFont(C.font.basic_font, C.font.basic_font_size, C.font.basic_font_style)
