...
local menuList = {
	...
	},
	{
		...
		icon = 'Interface\\Addons\\KkthnxUI\\Modules\\ActionBars\\media\\picomenu\\picomenuAchievement',
		func = function()
...
f:SetNormalTexture('Interface\\Addons\\KkthnxUI\\Media\\Actionbars\\picomenu\\picomenuNormal')
f:GetNormalTexture():SetSize(30, 30)

f:SetHighlightTexture('Interface\\Addons\\KkthnxUI\\Media\\Actionbars\\picomenu\\picomenuHighlight')
