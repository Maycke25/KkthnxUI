...
hooksecurefunc("GameTooltip_SetDefaultAnchor", function(self, parent)
	...
	if ( MultiBarLeft:IsShown() ) then
		self:SetPoint("BOTTOMRIGHT", MultiBarLeftButton12, "BOTTOMLEFT", -4, -3)
	elseif ( MultiBarRight:IsShown() ) then
		self:SetPoint("BOTTOMRIGHT", MultiBarRightButton12, "BOTTOMLEFT", -4, -3)
	else
		self:SetPoint("BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -2, 2)
	end
end)
