...
local defaults = {
	...
	statusbarNAME 			= "KkthnxTex",
	overlaybarNAME 			= "KkthnxTex",
	fonttextNAME 			= "UF_Font",
	...
	layouts = {
		["raid40"] = { width = 50, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 7, -7 } },
		["raid25"] = { width = 80, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 7, -7 } },
		["raid10"]	= { width = 80, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 7, -7 } },
		["party"]	= { width = 80, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 7, -7 } },
	},
...
function addon:OnInitialize(event, ...)
	...
	SharedMedia:Register("font", 		"UF_Font",  			path.."fontSmall.ttf")
	SharedMedia:Register("font", 		"NORM_Font",   			path.."fontThick.ttf")
	SharedMedia:Register("statusbar", 	"KkthnxTex", 			path.."HalH.tga")
	SharedMedia:Register("statusbar", 	"KkthnxTex", 			path.."HalM.tga")
...
function addon:CreateHeaders(width, height, scale)
	...
	for i = 1, NUM_RAID_GROUPS do
		local header = oUF:SpawnHeader("oUF_AbuRaid"..i, nil, 'solo,party,raid',
		"showPlayer", true,
		'showParty', false,
		'showRaid', true,
		'showSolo', false,
