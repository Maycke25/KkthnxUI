...
local defaults = {
	...
	layouts = {
		["raid40"] 	= { width = 50, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 5, -5 } },
		["raid25"] 	= { width = 80, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 5, -5 } },
		["raid10"] 	= { width = 80, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 5, -5 } },
		["party"] 	= { width = 80, height = 40, scale = 1, position = {"TOPLEFT", "UIParent", "TOPLEFT", 5, -5 } },
	},
