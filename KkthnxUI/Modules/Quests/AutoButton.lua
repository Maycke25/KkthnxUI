...
if C.misc.questautobutton ~= true then return end

----------------------------------------------------------------------------------------
--	AutoButton for used items(by Elv22) (use macro /click AutoButton)
----------------------------------------------------------------------------------------
local Items = K.ABItems
local EquipedItems = K.ABEquipedItems
...
AutoButton.c:SetFont(C.font.basic_font, C.font.basic_font_size * 2, C.font.basic_font_style)
