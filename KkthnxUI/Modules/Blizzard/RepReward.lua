...
function CalcBonusRep(factionName)
	...
	if IsInGuild() then
		...
		if guildLevel and guildLevel >= 12 then
			bonusRep = bonusRep + 0.1
		elseif guildLevel and guildLevel >= 4 then
			bonusRep = bonusRep + 0.05
		end
	end
	]]
